...
[`@aws-sdk/client-migration-hub`](https://www.npmjs.com/package/@aws-sdk/client-migration-hub/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pq9vnEWCGKs4RnAYLdzFzAoylDokE7TmlloSR+7H5pHC/GLv1AGOCDOchCOdKbgX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-migration-hub": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-migration-hub@3.925.0/index.min.mjs": "sha384-Pq9vnEWCGKs4RnAYLdzFzAoylDokE7TmlloSR+7H5pHC/GLv1AGOCDOchCOdKbgX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-migration-hub/blob/refs/tags/3.925.0/LICENSE
```
